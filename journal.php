...
<main role="main" class="container">
      <div class="row">
        <div class="col-12 blog-main">
          <h3 class="pb-3 mb-4 font-italic border-bottom zquotes">
            Journal
          </h3>

          <div class="blog-post">
            <h2 class="blog-post-title blog-title">Chungking Express</h2>
            <p class="blog-post-meta blogPostdate">July 11, 2018 by <a href="#" class="text-warning">zazameimei</a></p>
            <hr>
            <br>
            <img src="assets/images/008.png" class="mx-auto d-block" alt="" height="90%" width="90%" >
            <br>
            <div class="para">
          ...
          <div class="blog-post">
          <hr>
            <h2 class="blog-post-title blog-title">Madam X</h2>
           
            <p class="blog-post-meta blogPostdate">July 11, 2018 by <a href="#" class="text-warning">zazameimei</a></p>
            <hr>
            <br>
            <br>
            <img src="assets/images/009.png" class="mx-auto d-block" alt="" height="90%" width="90%" >
            <br>
            <div class="para">
            <p>Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis vestibulum. Sed posuere consectetur est at lobortis. Cras mattis consectetur purus sit amet fermentum.</p>
            <blockquote>
          ...
          <br>
            <hr>
          <div class="blog-post">
            <h2 class="blog-post-title blog-title">Super High Art</h2>
            
            <p class="blog-post-meta blogPostdate">July 11, 2018 by <a href="#" class="text-warning">zazameimei</a></p>
            <hr>
            <br>
            <img src="assets/images/007.png" class="mx-auto d-block" alt="" height="90%" width="90%" >
            <br>
            <div class="para">
            <p>Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Aenean lacinia bibendum nulla sed consectetur. Etiam porta sem malesuada magna mollis euismod. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus.</p>
          ...
          <nav class="blog-pagination">
            <a class="btn btn-outline-warning" href="#">Older</a>
        ...
        <!-- <aside class="col-md-4 blog-sidebar">
          ...
          <div class="p-3">
            ...
            <ol class="list-unstyled mb-0 text-warning">
